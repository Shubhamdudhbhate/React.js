...
const Expensesbycategory = (props) => {
  // Calculate total
  const total = props.food + props.travel + props.bills + props.others || 1;

  // Calculate degrees for pie chart
  const foodDeg = (props.food / total) * 360;
  const travelDeg = (props.travel / total) * 360;
  const billsDeg = (props.bills / total) * 360;
  ...
  return (
    <div>
      ...
      >
        <p style={{ paddingTop: "20px", marginLeft: "50px", fontSize: "35px" }}>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div style={{ marginLeft: "70px", marginTop: "45px" }}>
            <ul>
              <li style={{ listStyleType: "none", fontSize: "35px" }}>
                <span style={{ color: "red", fontSize: "35px" }}>{'\u2022'}</span>
                Food
              </li>
              <li style={{ listStyleType: "none", fontSize: "35px" }}>
                <span style={{ color: "green", fontSize: "35px" }}>{'\u2022'}</span>
                Travel
              </li>
              <li style={{ listStyleType: "none", fontSize: "35px" }}>
                <span style={{ color: "blue", fontSize: "35px" }}>{'\u2022'}</span>
                Bills
              </li>
              <li style={{ listStyleType: "none", fontSize: "35px" }}>
                <span style={{ color: "yellow", fontSize: "35px" }}>{'\u2022'}</span>
                Others
              </li>
            </ul>
          </div>
